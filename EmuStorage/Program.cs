...
namespace EmuStorage
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            storages.Add(new PocketHDD("Toshiba Canvio READY", "HDTP210EK3AA", 12000, 64, 16777216, 50331648, 50331648));
        ...
        private static void SelectMenu(int number)
        {
            Console.Clear();
            switch (number)
            {
                ...
                case 2:
                    ...
                    var result = Storage.Copy(source, destination);
                    if(result == ResultCopy.Ok)
                    {
